...
if [[ ! -d "$OVERLAY_DIR/demo_apps/tof_demo" ]]; then
...
cp -a "$OVERLAY_DIR/demo_apps/tof_demo" "$MCUX_EXAMPLES_DIR/demo_apps/"
cp -a "$OVERLAY_DIR/_boards/frdmmcxn947/demo_apps/tof_demo" "$MCUX_EXAMPLES_DIR/_boards/frdmmcxn947/demo_apps/"

echo "Installed tof_demo wrapper into: $MCUX_EXAMPLES_DIR"
